...
void freemapwalk(pagetable_t pagetable)
{
...
// mapped the userpage address to kernel page address
int userpage_map_kernelpage(pagetable_t userpage, pagetable_t kernelpage, uint64 va, uint64 sz)
{
  if (va + sz >= PLIC)
    return -1;
